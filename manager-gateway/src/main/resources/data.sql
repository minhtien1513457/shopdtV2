insert into shop_dt_manager_gateway.roles (id, name, description, created_date, updated_date, deleted_at)
...
insert into shop_dt_manager_gateway.users (id, username, email, password, role_id, created_date, updated_date, deleted_at)
...
insert into shop_dt_manager_gateway.manufacturers (id, name, description, created_date, updated_date, deleted_at)
...
insert into shop_dt_manager_gateway.products (id, name, description, status, price, total, manufacturer_id, created_date, updated_date, deleted_at)
